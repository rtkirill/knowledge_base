$(document).ready(function () {
    ...
    $("#print").click(function (e) {
        ...
        $('.print_version').printThis({
            ...
            loadCSS: "/bitrix/templates/trbonet_kb/styles.css",                // path to additional css file - use an array [] for multiple
    ...
    $('.support_button').on('click', function () {
        ...
        // $(".mfp-content>div").load("/kb/ajax/feedback.php");
        return false;
    });
