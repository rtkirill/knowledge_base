<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die(); ?><div id="contacts" class="tn_form__wrapper l-constrained l-flow">
	<? if (strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' && $_REQUEST['AJAX_FORM'] == 'contacts') $APPLICATION->RestartBuffer(); ?>
	<? $auto_focus = 0;
	$FL_req = 0; ?>
	...
	<? if (strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' && $_REQUEST['AJAX_FORM'] == 'contacts') {
			CEvent::CheckEvents();
			die();
	} ?>
</div>
