...
?>
    <article>
        <!--left main section-->
        <aside>
            <? $APPLICATION->IncludeComponent("bitrix:news.list", "left_main_section", Array(
                    "DISPLAY_DATE" => "Y",
                    "DISPLAY_NAME" => "Y",
                    "DISPLAY_PICTURE" => "Y",
        ...
        <section class="index_faq">
            ...
            <label for="search" class="search_label">
                <input type="text" class="search" id="search" value="" placeholder="Search our Knowledge Base...">
	...
	C17.6,49,27.9,52.7,28,56z" class="st2_1537378854447" vector-effect="non-scaling-stroke"></path>
                ...
                <p>
                    ...
                    Here you can find the answers to frequently asked questions, information about workarounds, known
                    issues
                    and
        ...
        <aside>
            <ul class="right_aside">
                <li>
                    ...
                    <? $APPLICATION->IncludeComponent("bitrix:news.list", "right_section", Array(
                            "DISPLAY_DATE" => "Y",
                            "DISPLAY_NAME" => "Y",
                            "DISPLAY_PICTURE" => "Y",
                            "DISPLAY_PREVIEW_TEXT" => "Y",
